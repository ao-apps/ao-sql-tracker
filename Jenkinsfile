...
def upstreamProjects = [
  ...
  'collections-transformers', // <groupId>com.aoapps</groupId><artifactId>ao-collections-transformers</artifactId>
  'lang', // <groupId>com.aoapps</groupId><artifactId>ao-lang</artifactId>
  'sql-wrapper', // <groupId>com.aoapps</groupId><artifactId>ao-sql-wrapper</artifactId>
]
