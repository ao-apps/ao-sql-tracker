 ...
 */
public class ParameterMetaDataTrackerImpl extends ParameterMetaDataWrapperImpl
    implements ParameterMetaDataTracker, AllocationStacktraceProvider {

  private static final Logger logger = Logger.getLogger(ParameterMetaDataTrackerImpl.class.getName());

  private final Exception allocationStacktrace;

  /**
   * Creates a new {@link ParameterMetaData} tracker.
   */
