 ...
 */
public class ResultSetMetaDataTrackerImpl extends ResultSetMetaDataWrapperImpl
    implements ResultSetMetaDataTracker, AllocationStacktraceProvider {

  private static final Logger logger = Logger.getLogger(ResultSetMetaDataTrackerImpl.class.getName());

  private final Exception allocationStacktrace;

  /**
   * Creates a new {@link ResultSetMetaData} tracker.
   */
