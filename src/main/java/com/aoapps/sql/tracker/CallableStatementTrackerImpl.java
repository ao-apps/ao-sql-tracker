 ...
 */
public class CallableStatementTrackerImpl extends CallableStatementWrapperImpl
    implements CallableStatementTracker, AllocationStacktraceProvider {
  ...
  /**
   * Creates a new {@link CallableStatement} tracker.
   */
